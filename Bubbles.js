...
function Bubbles(container, self, options) {
  ...
  var standingAnswer = "intro" // restart convo here if interrupted
  ...
  var iceBreaker = false //  this is the initative bot interaction or not
...
// add all HTML and CSS necessary for chat-bubble to function
